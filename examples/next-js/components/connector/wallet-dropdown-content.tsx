...
import { Wallet, Copy, Globe, Check, RefreshCw, Coins, History, ExternalLink, ArrowUpRight, ArrowDownLeft, LogOut } from 'lucide-react';
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    ...
                                    >
                                        ...
                                        <span className={`absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full border-2 border-background ${clusterColors[cluster?.id || ''] || 'bg-emerald-500'}`} />
                                    </Button>
                                </DropdownMenuTrigger>
                            ...
                            render={({ tokens, isLoading }) => (
                                <div className="space-y-2 pb-2">
                                    {isLoading ? (
                                        ...
                                        <p className="text-sm text-muted-foreground text-center py-2">No tokens found</p>
                                    )}
                                </div>
                            )}
                        />
                                        ...
                                        transactions.map(tx => (
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    {/* Direction indicator */}
                                                    <div className={`absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full flex items-center justify-center border-2 border-background ${
                                                        tx.direction === 'in' 
